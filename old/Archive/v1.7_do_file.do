...
* 4. THE $1 "MOVING STOCKS" FILTER
* The text says they drop stocks that are "removed from the test group" 
* due to price decline. This implies a firm-level drop.
bysort permno: egen min_price = min(abs(prc))
drop if min_price < 1
drop min_price
